...
namespace VRFPSKit.Input
{
    ...
    ""controlSchemes"": [
        ...
        ~@InputActions()
        {
            Debug.Assert(!m_XRIHead.enabled, "This will cause a leak and performance issues, InputActions.XRIHead.Disable() has not been called.");
            Debug.Assert(!m_XRILeftHand.enabled, "This will cause a leak and performance issues, InputActions.XRILeftHand.Disable() has not been called.");
            Debug.Assert(!m_XRILeftHandInteraction.enabled, "This will cause a leak and performance issues, InputActions.XRILeftHandInteraction.Disable() has not been called.");
            Debug.Assert(!m_XRILeftHandLocomotion.enabled, "This will cause a leak and performance issues, InputActions.XRILeftHandLocomotion.Disable() has not been called.");
            Debug.Assert(!m_XRIRightHand.enabled, "This will cause a leak and performance issues, InputActions.XRIRightHand.Disable() has not been called.");
            Debug.Assert(!m_XRIRightHandInteraction.enabled, "This will cause a leak and performance issues, InputActions.XRIRightHandInteraction.Disable() has not been called.");
            Debug.Assert(!m_XRIRightHandLocomotion.enabled, "This will cause a leak and performance issues, InputActions.XRIRightHandLocomotion.Disable() has not been called.");
            Debug.Assert(!m_XRIUI.enabled, "This will cause a leak and performance issues, InputActions.XRIUI.Disable() has not been called.");
        }
