...
public partial class @HVRInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@HVRInputActions()
    {
        Debug.Assert(!m_LeftHand.enabled, "This will cause a leak and performance issues, HVRInputActions.LeftHand.Disable() has not been called.");
        Debug.Assert(!m_RightHand.enabled, "This will cause a leak and performance issues, HVRInputActions.RightHand.Disable() has not been called.");
        Debug.Assert(!m_HMD.enabled, "This will cause a leak and performance issues, HVRInputActions.HMD.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, HVRInputActions.UI.Disable() has not been called.");
    }
